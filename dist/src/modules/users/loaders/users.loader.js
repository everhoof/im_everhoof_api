...
let UsersLoader = class UsersLoader extends nestjs_graphql_dataloader_1.OrderedNestDataLoader {
    constructor(usersRepository) {
        super();
        this.usersRepository = usersRepository;
        this.getOptions = () => ({
            query: (keys) => this.usersRepository.findByIds(keys),
        });
    }
};
UsersLoader = __decorate([
