...
export declare type ExceptionKey = 'UNKNOWN' | 'FORBIDDEN' | 'USER_DOES_NOT_EXIST' | 'USER_DOES_NOT_EXIST_WITH_ID' | 'USER_ALREADY_PUNISHED' | 'USER_IS_NOT_PUNISHED' | 'USERNAME_OCCUPIED' | 'EMAIL_OCCUPIED' | 'WRONG_CREDENTIALS' | 'NO_FILE_PROVIDED' | 'CANNOT_CREATE_EMPTY_MESSAGE' | 'YOU_ARE_MUTED' | 'YOU_ARE_BANNED';
